...
from pma_apps.landing_page.forms import EmailForma, KontaktForma
...
def kontakt_hello_message(request):
    ...
    return render(
        request, "landing_page/partials/kontakt_hello_message.html", context=context
    )
    ...
    if request.method == "GET":
        ...
        if form.is_valid():
            ...
            if not ime or tema or email or pitanje:
                ...
                return render(
                    request, "landing_page/partials/send_email.html", {"form": form}
                )
