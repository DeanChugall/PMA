...
class AutoServis(models.Model):
    ...
    creator = models.ForeignKey(
        Servis, on_delete=models.PROTECT, related_name="kreaator_auto_servisa", default=1
    )
    category = models.ForeignKey(
        KategorijaAutoServisa, on_delete=models.CASCADE, related_name="kategorija_auto_servisa", default=1
    )
